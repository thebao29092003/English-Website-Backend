...
namespace English.Website.Application.Services
{
    public class TurnstileService : ITurnstileService
    {
        ...
        public TurnstileService(HttpClient httpClient, IConfiguration configuration)
        {
            ...
            _secretKey = configuration["Cloudfare:TurnStileKey"] ?? string.Empty;
            _verifyUrl = configuration["Cloudfare:VerifyUrl"] ?? "https://challenges.cloudflare.com/turnstile/v0/siteverify";
        }
